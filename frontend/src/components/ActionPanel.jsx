...
const ActionPanel = ({ userData, postAndShowDeclaration, accessToken }) => {
        ...
        <div className="md:w-1/4 p-5 bg-white rounded-lg shadow-lg">
            <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-4">
                ...
                <nav className="space-y-4">
                    ...
                    <button className="flex items-center text-gray-600 hover:text-gray-800"  onClick={() => setShowAgreementDialog(true)}>
                        <svg className="h-6 w-6 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
